...
public class ContactListAdapter extends RecyclerView.Adapter<ContactListAdapter.ListViewHolder> {
    ...
    public ContactListAdapter.ListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.
                ...
                inflate(com.sdsmdg.pulkit.callingtext.R.layout.contact_card, parent, false);
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ListViewHolder(View vi) {
            super(vi);
            name = (TextView) vi.findViewById(com.sdsmdg.pulkit.callingtext.R.id.textView6);
            phoneNumber=(TextView) vi.findViewById(com.sdsmdg.pulkit.callingtext.R.id.textView7);
            textsmsLogo=(ImageButton) vi.findViewById(com.sdsmdg.pulkit.callingtext.R.id.imageButton21);
